...
const TicketBuyDiagramCard = ({ imgSrc, text, index }: TicketBuyDiagramCardProps) => {
  return (
    <div className="relative rounded-lg border-secondary border-3 gap-8 shadow-lg bg-white grid grid-rows-10 flex-col flex-1 w-full mt-8 px-4 pt-16 pb-4 ticket-diagram-card">
      ...
      <div className="row-span-6 card-img" style={{ backgroundImage: `url(${imgSrc})` }} />
      {text && (
