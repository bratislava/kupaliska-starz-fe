...
const Ticket = ({ ticket }: TicketProps) => {
  ...
  return (
    <div className="inline-flex w-full flex-col items-center gap-6 px-8">
      ...
      {ticketType && <span className="text-xl leading-7 font-semibold">{ticketType.name}</span>}
  ...
  return (
    <div className="relative">
      ...
      {displayButtons.previous && (
        <AriaButton
          className="border-divider bg-sunscreen absolute top-[calc(50%-48px)] -left-6 z-10 flex h-12 w-12 items-center justify-center rounded-full border-2"
      ...
      {displayButtons.next && (
        <AriaButton
          className="border-divider bg-sunscreen absolute top-[calc(50%-48px)] -right-6 z-10 flex h-12 w-12 items-center justify-center rounded-full border-2"
          onPress={handleNext}
        >
