...
export type ButtonProps = Omit<AriaButtonProps, keyof LinkButtonProps | 'children'> &
  ButtonBase & {
    href?: never
    target?: never
    hasLinkIcon?: never
  ...
  (
    ...
    const styles = cx(
      ...
      `
        ...
        font-semibold leading-[1.5rem] transition
      `,
...

      {
        ...
        'px-4 py-2 lg:py-3': size === 'responsive' && !isIconButton && isSolidOrOutlineVariant,
        ...
        'data-hovered:bg-category-100 data-hovered:text-category-600': variant === 'category-plain',

        'data-hovered:border-gray-600 data-hovered:bg-gray-600': variant === 'black-solid',
        'data-hovered:border-gray-200 data-hovered:text-gray-600': variant === 'black-outline',
        ...
        'data-hovered:border-negative-600 data-hovered:bg-negative-600':
          variant === 'negative-solid',
        'data-hovered:bg-negative-100 data-hovered:text-negative-600': variant === 'negative-plain',
