  ...
  return (
    ...
    >
      {cloneElement(
        wrapper,
        {},
        <AriaDialog className="bg-sunscreen flex max-h-[calc(70vh-8px)] max-w-[calc(100vw-8px)] flex-col rounded-lg">
          <div className="border-b-divider flex flex-row items-center justify-between gap-6 border-b-2 px-6 py-4">
          ...
          {footerButton && (
            <div className="border-t-divider flex flex-col items-end border-t-2 px-6 py-4">
              {footerButton}
            </div>
          )}
        </AriaDialog>,
