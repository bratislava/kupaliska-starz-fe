...
module.exports = {
  ...
  plugins: [
    ...
    [
      ...
      {
        prepareCmd:
          'docker login -u "$CI_REGISTRY_USER" -p "$CI_REGISTRY_PASSWORD" $CI_REGISTRY && (docker pull -q "$CI_REGISTRY_IMAGE:latest" || true)',
      },
    ],
    [
      '@codedependant/semantic-release-docker',
      {
        dockerTags: ['latest', '{git_sha}', '{version}', '{major}', '{major}.{minor}'],
